        ...
        <div class="container mt-4">
            <div class="card">
                ...
                <div class="card-body text-center">
                    ...
                    <p class="card-text"><strong>البريد الإلكتروني:</strong> {{ $employee->email }}</p>
                ...
                <div class="text-center">
                    <a href="adminPage.html">
                        <button class="btn btn-outline-primary my-2" type="button">
                            <i class="fa fa-add"></i> add or manage vacations
                        </button>
